...
public class CriadorSlimesController : MonoBehaviour
{
    ...
    private float multiplicadorHambre = 1f;
    ...
    {
        float currentSpeed = (isRunning ? runSpeed : moveSpeed) * multiplicadorHambre;
        rb.linearVelocity = new Vector2(horizontalInput * currentSpeed, rb.linearVelocity.y);
    }

    public void SetMultiplicadorHambre(float multiplicador)
    {
        multiplicadorHambre = Mathf.Clamp(multiplicador, 0.45f, 1f);
    }
